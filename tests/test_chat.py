...
def test_multiple_model_response():
    ...
    with patch('irouter.chat.Call') as mock_call_class:
        ...
        assert multi_chat.history == {"model1": [{'role': 'system', 'content': 'You are a helpful assistant.'}, 
                                                 {'role': 'user', 'content': 'Hello'}, 
                                                 {'role': 'assistant', 'content': 'Model1 response'}], 
                                      "model2": [{'role': 'system', 'content': 'You are a helpful assistant.'}, 
                                                 {'role': 'user', 'content': 'Hello'}, 
                                                 {'role': 'assistant', 'content': 'Model2 response'}]}
        assert multi_chat.usage == {"model1": {"prompt_tokens": 10, "completion_tokens": 5, "total_tokens": 15}, 
